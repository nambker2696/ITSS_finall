...
#include <stdio.h>
int *shm_data;
GtkWidget *button1, *image_light, *image_light;
...
gboolean nofication(gpointer data){
	...
	int value;
	//Set image cho button_nofication
	if(shm_data[0] == 1 && !set_green){
		...
		switch(value){
			case 2: gtk_widget_set_name(button2, "info_btn");
			break;
			case 3:gtk_widget_set_name(button3, "info_btn");
			break;
			case 4: gtk_widget_set_name(button4, "info_btn");
			break;
			case 5: gtk_widget_set_name(button5, "info_btn");
			break;
		}
	}
